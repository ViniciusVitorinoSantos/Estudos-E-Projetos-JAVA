...
public class CalculoDelta extends javax.swing.JFrame {
    ...
    public CalculoDelta() {
        initComponents();
        panResultado.setVisible(false);//Esconde o painel de resultados 
    }
    ...
    //SETA OS VALORES NOS LABELS EM TEMPO REAL
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        //RECEBENDO OS VALORES DOS SPINERS E CONVERTENDO PARA INT
        ...
        lblDelta.setText(String.format("%.1f", d));//mostra delta
        //TIPOS DE RAIZES 
        if(d < 0){
        ...
        panResultado.setVisible(true);// Mostra o painel de resultado ao clicar no botão
